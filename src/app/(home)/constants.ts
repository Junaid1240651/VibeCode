export const PROJECT_TEMPLATES = [
    ...
    },
    {
        ...
        prompt:
            "Build a kanban board with drag-and-drop and support for adding and removing tasks with local state. Use consistent spacing, column widths, and hover effects for a polished UI.",
    },
    {
        emoji: "🗂️",
